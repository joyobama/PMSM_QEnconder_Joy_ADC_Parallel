...
User_program/Spi.obj: ../User_program/Spi.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C2000 Compiler'
	"C:/ti/ccsv8/tools/compiler/ti-cgt-c2000_18.1.2.LTS/bin/cl2000" -v28 -ml -mt --float_support=fpu32 --include_path="E:/workspace_2021/PMSM_QEnconder_Joy_ADC_parallel" --include_path="E:/workspace_2021/PMSM_QEnconder_Joy_ADC_parallel/TI_include" --include_path="E:/workspace_2021/PMSM_QEnconder_Joy_ADC_parallel/User_include" --include_path="C:/ti/ccsv8/tools/compiler/ti-cgt-c2000_18.1.2.LTS/include" -g --diag_warning=225 --diag_wrap=off --display_error_number --preproc_with_compile --preproc_dependency="User_program/Spi.d_raw" --obj_directory="User_program" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
